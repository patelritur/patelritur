...
public class VirtualMeetingPlaceViewModel extends AndroidViewModel {

    private LiveData<MenuResponse> menuResponseLiveData;

    public VirtualMeetingPlaceViewModel(@NonNull Application application) {
        super(application);
    ...
    private LiveData<MenuResponse> getMenuList() {
        ...
        Call objectCall = RestClient.getApiService().virtualmeettype();
