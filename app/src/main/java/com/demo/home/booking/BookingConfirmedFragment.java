...
public class BookingConfirmedFragment extends Fragment implements ApiResponseListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        fragmentBookingBookedBinding.performaInvoice.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        fragmentBookingBookedBinding.call.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        fragmentBookingBookedBinding.joinCall.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    public void onApiResponse(Call<Object> call, Object response, int reqCode) throws Exception {
        ...
        if(reqCode==1) {
            ...
            if (bookingAcceptModel.getResponseCode().equalsIgnoreCase("200")) {
                ...
                getDestinationInfo(fragmentBookingBookedBinding.arrivingTime,bookingAcceptModel.getBookingdetails().getSpecialistLatitude(),bookingAcceptModel.getBookingdetails().getSpecialistLongitude());

                updateCarCheckList();
                fragmentBookingBookedBinding.executePendingBindings();

                if(bookingAcceptModel.getBookingdetails().getDemoStatusId().equalsIgnoreCase("5")){
                ...
                else if(bookingAcceptModel.getBookingdetails().getDemoStatusId().equalsIgnoreCase("2")
                        || bookingAcceptModel.getBookingdetails().getDemoStatusId().equalsIgnoreCase("3") || bookingAcceptModel.getBookingdetails().getDemoStatusId().equalsIgnoreCase("4")
                ){
                    fragmentBookingBookedBinding.call.setVisibility(View.GONE);
                    fragmentBookingBookedBinding.submessage.setVisibility(View.VISIBLE);
                    fragmentBookingBookedBinding.arrivingTime.setVisibility(View.GONE);
                    getDestinationInfo(fragmentBookingBookedBinding.submessage,bookingAcceptModel.getBookingdetails().getSpecialistLatitude(),bookingAcceptModel.getBookingdetails().getSpecialistLongitude());


                }
                else if(bookingAcceptModel.getBookingdetails().getDemoStatusId().equalsIgnoreCase("9") ){
                    fragmentBookingBookedBinding.call.setVisibility(View.GONE);
                    fragmentBookingBookedBinding.submessage.setVisibility(View.VISIBLE);
                    fragmentBookingBookedBinding.arrivingTime.setVisibility(View.GONE);
                    fragmentBookingBookedBinding.llTimeSlot.setVisibility(View.VISIBLE);

                    getDestinationInfo(fragmentBookingBookedBinding.submessage,bookingAcceptModel.getBookingdetails().getSpecialistLatitude(),bookingAcceptModel.getBookingdetails().getSpecialistLongitude());


                }
                else if(bookingAcceptModel.getBookingdetails().getDemoStatusId().equalsIgnoreCase("10")){
                    fragmentBookingBookedBinding.call.setVisibility(View.VISIBLE);
                    fragmentBookingBookedBinding.submessage.setVisibility(View.VISIBLE);
                    fragmentBookingBookedBinding.arrivingTime.setVisibility(View.VISIBLE);
                    getDestinationInfo(fragmentBookingBookedBinding.arrivingTime,bookingAcceptModel.getBookingdetails().getSpecialistLatitude(),bookingAcceptModel.getBookingdetails().getSpecialistLongitude());
                }
                else {
    ...
    private String getNextTime(int format) {
        ...
        String formattedDate = df.format(afterAdding10Mins);

        return formattedDate;

    }

    private void getDestinationInfo(AppCompatTextView arrivingTime, String specialistLatitude, String specialistLongitude) {
...
// Reading data from url
    ...
    private void extracted(BookingAcceptModel bookingAcceptModel) {
