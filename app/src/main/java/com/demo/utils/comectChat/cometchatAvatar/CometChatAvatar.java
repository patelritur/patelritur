package com.demo.utils.comectChat.cometchatAvatar;
...
public class CometChatAvatar extends MaterialCardView {
    ...
    private void getAttributes(AttributeSet attrs) {
        ...
        backgroundColor = a.getColor(R.styleable.Avatar_background_color,
                getResources().getColor(R.color.color_241e61));
        avatarUrl = a.getString(R.styleable.Avatar_avatar);
        borderColor = a.getColor(R.styleable.Avatar_border_color,getResources().getColor(R.color.color_241e61));
