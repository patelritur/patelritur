...
import com.demo.R;
import com.demo.utils.comectChat.CameraPreview;
import com.demo.utils.comectChat.FeatureRestriction;
import com.demo.utils.comectChat.UIKitConstants;
import com.demo.utils.comectChat.call_manager.helper.CometChatAudioHelper;
import com.demo.utils.comectChat.call_manager.helper.OutgoingAudioHelper;
import com.demo.utils.comectChat.cometchatAvatar.CometChatAvatar;
import com.demo.utils.comectChat.utils.AnimUtil;
...
public class CometChatCallActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void setValues() {
     ...
     //   if (avatar!=null)
        {
            userAv.setAvatar("http://65.2.85.224/Resources/ProfilePic/profimg.png");
            callerAvatar.setAvatar("http://65.2.85.224/Resources/ProfilePic/profimg.png");
        }
    }
